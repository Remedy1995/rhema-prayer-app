...
export default function OnboardingStack(props) {
  return (
    ...
    >
      <Stack.Screen
        name="Onboarding"
        component={BibleBottomNavigator}
        option={{
          headerTransparent: true,
        }}
      />
...
const BibleBottomNavigator = () => {
  return (
    <>
      <StatusBar barStyle="dark-content" hidden={false} backgroundColor={'brown'} translucent={true} />
      <BottomTabs.Navigator screenOptions={{
        headerStyle: { backgroundColor: Colors.primaryColor200 },
        headerTintColor: 'white',
        ...
        <BottomTabs.Screen name='Upload' component={Posts} options={{
          headerShown: false,
          tabBarIcon: ({ color }) => (<AntDesign name='addfile' size={30} color={color} />)
        }} />
        {/* <BottomTabs.Screen name='Bookings' component={UserBookings} options={{
          headerShown: true, tabBarIcon: ({ icon, color }) => (<AntDesign name='book' size={30} color={color} />)
        }} />

        <BottomTabs.Screen name='History' component={UserHistory} options={{
          headerShown: true, tabBarIcon: ({ icon, color }) => (<AntDesign name='home' size={30} color={color} />)
        }} />

        <BottomTabs.Screen name='Wallet' component={HandyUserWallet} options={{
    headerShown: true, tabBarIcon: ({ icon, color }) => (<AntDesign name='wallet' size={30} color={color} />)
  }} />

        <BottomTabs.Screen name='Settings' component={HandyUserSettings} options={{
          headerShown: true, tabBarIcon: ({ icon, color }) => (<Ionicons name='settings' size={30} color={color} />)
        }} /> */}
